...
// === Interested Projects ===
$sqlInterestedProject = "select * from " . _PROJECT_INTRESTED_TABLE_ . " where userId=" . intval($_SESSION["sessUserId"]);
...
<head>
	...
	<script>
		function bookmarkfun(id) {
			$('#loadbookmarkdiv').load('<?php echo $fullurl; ?>common_action.php?action=interested&pid=' + id);
		}
	</script>
</head>
			...
			<div class="center_content">
				...
				<div class="groups" style="min-height:500px; background-color:#fff;">
					...
					<ul class="manage-tab">
						...
						<li><a href="<?php echo $fullurl; ?>bookmarked-projects.html">Bookmarked projects
								<?php if ($totalBookmproject > 0) {
									echo '(' . $totalBookmproject . ')';
								} ?></a></li>
						<li><a href="<?php echo $fullurl; ?>interested-projects.html" class="active">Projects I am
								interested
					...
					<?php
					if ($totalInterestedproject == 0) {
						?>
						<div class="crtnw-prjct" style="text-align:center; padding-top:15%;">
							<strong>You have not shown your interest in working for any Project.</strong>
					...
					<?php } else { ?>
						...
						<div class="reslt">
							<span class="rslt-count"><?php echo $totalInterestedproject; ?> Result</span>
						...
						<ul class="project-list">
							...
							if ($totalInterestedproject > 0) {
								while ($rowProject1 = mysqli_fetch_array($resInterestedProject)) {
