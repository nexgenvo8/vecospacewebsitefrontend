...
$getuser2=mysql_fetch_array($res52);
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;max-width:550px">
                ...
                <tr>
                  <td align="center" width="100%" style="background:#fff;color:#484848;padding:40px;border-radius:4px;    border-bottom: #33a9d7 solid 5px;">
                      ...
                      <p align="center" style="margin:0 0 30px;padding:0;color:#484848"><strong><a href="'.$fullurl.'" style="color:#1a94c3; text-decoration:none;">'.$firstName2.'</a></strong> invited you to join their network on <a href="'.$fullurl.'" target="_blank" style="color:#1a94c3; text-decoration:none;">'.$companNameTitle.'</a></p>
                        ...
                        <div style="text-align:center; margin-top:10px;">Sign up for free and discover a world full of opportunities </div></td>
                </tr>
                <tr>
