...
<div id="successmessage-outer" style="display: none;" class="warningmessage">
  <div id="successmessage" style="background-color: #860E66 !important;">
    <div class="msgimg">
      <i class="fa fa-check" aria-hidden="true"></i>
    </div>
    <div class="successmsg-heading">
    ...
    <div class="donebtn" onclick="closeserrormsg();" style="background-color: #860E66 !important;">
      OK
    </div>
  </div>
</div>
    ...
    <div class="container">
      ...
      <div class="footer-menu" style="margin-top:9px;">
        <ul class="foooter-list">
          <li><a href="<?php echo $fullurl; ?>sdg-pvcypage.html">Privacy</a></li>
