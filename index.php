	...
	<div id="wrapper">
		<header class="container">
			<div class="logo logo_marg"><a href="<?php echo $fullurl; ?>"><img
						src="<?php echo $fullurl; ?>images/sdglogo.png" style="margin-top: 10px;"></a></div>
			...
			<div class="banner">
				<div class="mobile-overlay-container">
					<div class="mobile-message">
						...
						<div style="font-size:20px; font-weight:500;">SDG COMNET</div>
					</div>
				</div>
				...
				<div class="footer-left2"><strong>
						<div>
							<div style="font-weight:normal;">
								<div style="float:left;">© 2023&nbsp;SDG COMNET VECOSPACE &nbsp;|
									&nbsp;Powered by &nbsp;&nbsp;&nbsp;</div>
