...
$sql_ins="update "._SHAREANDUPDATES_TABLE_." set status='$status' where  postType='3' and id = ".$id."";			
...
$classlist=1;			
	 $query = "SELECT COUNT(*) as num FROM "._SHAREANDUPDATES_TABLE_."  where postType='3' order by id desc ";			
	...
	$query1 = "SELECT * FROM "._SHAREANDUPDATES_TABLE_."  where postType='3' order by id desc LIMIT $start, $limit";			
	...
	<div class="listingbox" style="position:relative; min-height:300px;">			
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">			
        <tr>
          ...
          <td width="33%" align="left" valign="top" class="listingheaddr">Article Title</td>
		...
		<tr <?php if($classlist==1){ ?>style="background-color:#f7f7f7;" <?php }  else { ?>style="background-color:#FFFFFF;" <?php } ?>>
          ...
          <td align="left" valign="middle" class="graylist"><?php  echo stripslashes($res_post['postTitle']); ?></td>
...
?></td>
          ...
          <td align="center" valign="middle" class="graylist"><?php  echo date('m/d/Y H:i:s',$res_post['dateAdded']); ?></td>
          ...
          <td align="center" valign="top" class="graylist"><a href="<?php echo $websiteurl;?>articles-and-trivia/<?php echo encodeStr($res_post['id'])."/".$postTitle.".html";?>" target="_blank"><img src="images/eye_inv.png" alt="View" width="30" height="32" border="0" /></a></td>
        </tr>			
