	...
	<div class="optionsec">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
		 ...
		 <div class="box-div">
		 <div class="color-box" style="padding:10px; color:#fff; font-size:12px; background-color:#26A69A;border-left: 4px solid #ececec;border-radius: 4px; overflow: hidden; height:60px;">
		 ...
		 <div class="box-div">
		 <div class="color-box" style="padding:10px; color:#fff; font-size:12px; background-color:#2ca1cc;border-left: 4px solid #ececec;border-radius: 4px; overflow: hidden; height:60px;">
                          <div style="font-size:20px; font-weight:600;">
		 ...
		 <div class="box-div">
		 <div class="color-box" style="padding:10px; color:#fff; font-size:12px; background-color:#9466be;border-left: 4px solid #ececec;border-radius: 4px; overflow: hidden;height:60px;">
                          <div style="font-size:20px; font-weight:600;">
		 ...
		 <div class="box-div">
		 <div class="color-box" style="padding:10px; color:#fff; font-size:12px; background-color:#82b767;border-left: 4px solid #ececec;border-radius: 4px; overflow: hidden;height:60px;">
                          <div style="font-size:20px; font-weight:600;">
		 ...
		 <div class="box-div">
		 <div class="color-box" style="padding:10px; color:#fff; font-size:12px; background-color:#03c28d;border-left: 4px solid #ececec;border-radius: 4px; overflow: hidden;height:60px;">
                          <div style="font-size:20px; font-weight:600;">
		 ...
		 <div class="box-div">
		 <div class="color-box" style="padding:10px; color:#fff; font-size:12px; background-color:#c75858;border-left: 4px solid #ececec;border-radius: 4px; overflow: hidden;height:60px;">
                          <div style="font-size:20px; font-weight:600;">
	...
	<div class="listingbox" style="position:relative; min-height:300px;">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr <?php if($classlist==1){ ?>style="background-color:#f7f7f7;" <?php }  else { ?>style="background-color:#FFFFFF;" <?php } ?>>
          ...
          <td align="left" valign="middle" class="graylist"><?php $re="select * from "._OPTION_MASTER_TABLE_."  where id='".$res_post['industryId']."'";
...
?></td>
          ...
          <td align="left" valign="middle" class="graylist"><?php  echo stripslashes($res_post['email']); ?><?php $ee = stripslashes(trim($res_post['email'])); ?></td>
          <td align="center" valign="middle" class="graylist"><?php  echo $res_post['mobile']; ?></td>
          <td align="left" valign="middle" class="graylist"><input type="button" class="gradiantbtn" id="sendbutton<?php echo $res_post['userId']; ?>" onclick="funcResendEmail('<?php echo $res_post['userId']; ?>');" value="Resend Email" /></td>
          <td align="center" valign="middle" class="graylist"><?php  echo date('m/d/Y H:i:s',$res_post['regDate']); ?></td>
          <td align="center" valign="middle" class="graylist"><?php if($res_post['activeYN']=='Y'){ ?>
            <a href="<?php echo $backpage; ?>?status=N&id=<?php echo base64_encode($res_post['userId']); ?>&page=<?php echo $_GET['page']; ?>&unino=<?php echo $_SESSION["cust_session_token"]."_console";?>" onclick="globalloading();"><img src="images/unlock.png" width="30" border="0" /></a>
            <?php } else { ?><a href="<?php echo $backpage; ?>?status=Y&id=<?php echo base64_encode($res_post['userId']); ?>&page=<?php echo $_GET['page']; ?>&unino=<?php echo $_SESSION["cust_session_token"]."_console";?>" onclick="globalloading();"><img src="images/lock.png" /></a><?php } ?></td>
          <?php if($querywfs['id']==1){ ?>
		  <td align="center" valign="middle" class="graylist"><?php if(1=='1'){ ?>
            <a href="<?php echo $backpage; ?>?makeAdmin=0&id=<?php echo base64_encode($res_post['userId']); ?>&unino=<?php echo $_SESSION["cust_session_token"]."_console";?>" onclick="globalloading();"><img src="images/unlock.png" width="30" border="0" /></a>
            <?php } else { ?><a href="<?php echo $backpage; ?>?makeAdmin=1&id=<?php echo base64_encode($res_post['userId']); ?>&unino=<?php echo $_SESSION["cust_session_token"]."_console";?>" onclick="globalloading();"><img src="images/lock.png" /></a><?php } ?></td>
		  <?php } ?>
    ...
    <button type="button" class="gradiantbtn" 
        ...
        Edit
          ...
          <td align="center" valign="top" class="graylist"><a href="<?php echo $websiteurl;?>profile/<?php echo encodeStr($res_post['userId']); ?>/<?php echo $res_post['userurl']; ?>.html" target="_blank"><img src="images/eye_inv.png" alt="View" width="30" height="32" border="0" /></a></td>
