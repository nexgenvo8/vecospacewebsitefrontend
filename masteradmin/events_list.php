...
$sql_ins="update "._EVENT_MASTER_TABLE_." set eventStatus='$status',emailSent=1 where id = ".$id."";			
  ...
  <div style="margin:auto; width:600px; background-color:#FFFFFF; text-align:left;">
    <div style="padding:30px;">
      ...
      <div style="padding:10px; background-color:#F9F9F9; border:dashed 1px #ccc; border-radius: 2px;">
        ...
        <div style="display: block;width: 100%;margin-top: 15px;">Congratulations! The event that you posted on Konectt can now be seen by members of Konectt. You can edit the particulars at any time and delete the listing as well.<br>
          <br>
        You can view your listing on the Events page, by clicking on the "Events" link on the left side main menu bar. 
</div>
          </div>
        </div>
...
$classlist=1;			
	 $query = "SELECT COUNT(*) as num FROM "._EVENT_MASTER_TABLE_."  where eventName!='' order by id desc ";			
	...
	$query1 = "SELECT * FROM "._EVENT_MASTER_TABLE_." where eventName!='' order by id desc LIMIT $start, $limit";			
	...
	<div class="listingbox" style="position:relative; min-height:300px;">			
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">			
        <tr>
          ...
          <td width="33%" align="left" valign="top" class="listingheaddr">Event Name</td>
		...
		<tr <?php if($classlist==1){ ?>style="background-color:#f7f7f7;" <?php }  else { ?>style="background-color:#FFFFFF;" <?php } ?>>
          ...
          <td align="left" valign="middle" class="graylist"><?php  echo stripslashes($res_post['eventName']); ?></td>
...
?></td>
          ...
          <td align="center" valign="top" class="graylist"><a href="<?php echo $websiteurl;?>events/<?php echo encodeStr($res_post['id'])."/".$postTitle.".html";?>" target="_blank"><img src="images/eye_inv.png" alt="View" width="30" height="32" border="0" /></a></td>
        </tr>			
