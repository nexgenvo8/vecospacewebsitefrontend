...
$sql_ins="insert into noticeBoard set title='$title',detail='$detail',dateAdded='$dateAdded',modifyDate='$modifyDate',addedBy='$addedBy',modifyBy='$modifyBy'";
...
$backpage=$_POST['backpage'];
$sql_ins="update noticeBoard set title='$title',detail='$detail',modifyDate='$modifyDate',modifyBy='$modifyBy' where id = ".$id."";
...
$re="select * from noticeBoard  where id='".$_REQUEST['id']."'";
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="100%" align="left" valign="top"><table width="100%" border="0" cellpadding="8" cellspacing="0">
              <tr>
                <td width="19%" align="left" valign="top">Title</td>
                <td width="81%" align="left" valign="top">  
				<input name="title" type="text" id="title" value="<?php  echo stripslashes($post_result['title']); ?>" style="width:98%;" required>
				 </td>
              </tr>
          ...
          <td width="100%" align="left" valign="top"><table width="100%" border="0" cellpadding="8" cellspacing="0">
              <tr>
                <td width="19%" align="left" valign="top">Details</td>
                <td width="81%" align="left" valign="top">  
				<input name="detail" type="text" id="title" value="<?php  echo stripslashes($post_result['detail']); ?>" style="width:98%;" required>
				 </td>
              </tr>
              ...
              <tr>
          <td width="100%" align="left" valign="top" style="width:250px;"><div style="margin-left:10px;" class="featureimagebox">
