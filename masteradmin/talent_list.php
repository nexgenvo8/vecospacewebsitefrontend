		...
		<tr>
			...
			<input type="checkbox" name="check_list[]" class="chk" id="check_list[]"  value="<?php echo $res_post['userId']; ?>" />       </td>-->
										...
										<td align="left" valign="middle" class="graylist">
											<div style="width:50px; height:50px; overflow:hidden;"><img
													src="../uploads/<?php echo stripslashes($res_post['talentProfilePhoto']); ?>"
													width="62" height="32" style="width:50px !important;" /></div>
										</td>
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['talentName']); ?></td>
										<td align="left" valign="middle" class="graylist">
