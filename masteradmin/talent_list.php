...
//----Page Settings-----			
//$type="partner";			
$pagetitle = "Talent Connect"; 				
$targetpage = "talent_list.php"; 			
$limit =100;			
...
$sql_ins="update "._TALENT_MASTER_." set status='$status',emailSent=1 where id = ".$id."";			
  ...
  <div style="margin:auto; width:600px; background-color:#FFFFFF; text-align:left;">
    <div style="padding:30px;">
      ...
      <div style="padding:10px; background-color:#F9F9F9; border:dashed 1px #ccc; border-radius: 2px;">
        ...
        <div style="display: block;width: 100%;margin-top: 15px;">Thank you for creating your profile on Talent Connect. Your profile will be visible and can be viewed by Members of Konectt.<br>
          <br>
       You can view the same, by clicking on the "Talent Connect" link on the main menu bar, on the left side. You can edit the particulars at any time and delete the listing as well.
</div>
          </div>
        </div>
...
$classlist=1;			
	 $query = "SELECT COUNT(*) as num FROM "._TALENT_MASTER_."  order by id desc ";			
	...
	$query1 = "SELECT * FROM "._TALENT_MASTER_."  order by id desc LIMIT $start, $limit";			
	...
	<div class="listingbox" style="position:relative; min-height:300px;">			
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">			
        <tr>
          ...
          <td align="left" valign="top" class="listingheaddr">&nbsp;</td>			
          <td align="left" valign="top" class="listingheaddr">Banner</td>
          <!--<td width="2%" align="center" valign="top" class="listingheaddr"><input type="checkbox" id="chkAll" /></td>-->			
          <td align="left" valign="top" class="listingheaddr"> Name</td>
          <td align="left" valign="top" class="listingheaddr">Short Description </td>
          <!--<td width="17%" align="left" valign="top" class="listingheaddr">Email id</td>-->			
          <td align="center" valign="top" class="listingheaddr"> Date </td>
          <td align="center" valign="top" class="listingheaddr"> Posted By</td>
          <td align="center" valign="top" class="listingheaddr">Status</td>			
          <td align="center" valign="top" class="listingheaddr">Open</td>
        </tr>			
		...
		<tr <?php if($classlist==1){ ?>style="background-color:#f7f7f7;" <?php }  else { ?>style="background-color:#FFFFFF;" <?php } ?>>
		  ...
		  <div style="width:50px; height:50px; overflow:hidden;"><img src="../uploads/<?php  echo stripslashes($res_post['talentProfilePhoto']); ?>" width="62" height="32"  style="width:50px !important;"/></div></td>
          <td align="left" valign="middle" class="graylist"><?php  echo stripslashes($res_post['talentName']); ?></td>
