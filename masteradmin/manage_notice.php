...
$backpage = "manage_notice.php";
$targetpage = "manage_notice.php";
$tableName = "noticeBoard";
$addeditpage = "add_notice.php";
$limit = 100;
							...
							<tr>
								...
								<td width="150" align="right" style="width:150px;"><em><strong>
											...
											if ($_GET['searchkeywords'] != '') {
												$searchname = "and title='" . $_GET['searchkeywords'] . "'";
											}

											$classlist = 1;
											$query = "SELECT COUNT(*) as num FROM noticeBoard where  1 " . $searchname . " order by id desc ";
											...
											$query1 = "SELECT * FROM noticeBoard where  1 " . $searchname . " order by id desc LIMIT $start, $limit";
						...
						<div class="srchfcontct">
							...
							<div class="srch-field">
								<input type="text" name="searchkeywords" id="searchkeywords" maxlength="60"
									placeholder="Enter Notice" autocomplete="off"
						...
						<div class="listingbox" style="position:relative;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="53%" align="left" valign="top" class="listingheaddr">Title</td>
								...
								<?php while ($res_post = mysql_fetch_array($result)) { ?>
									<tr <?php if ($classlist == 1) { ?>style="background-color:#f7f7f7;" <?php } else { ?>style="background-color:#FFFFFF;" <?php } ?>>
										...
										<td align="left" valign="middle" class="graylist"><a
												...
												onclick="globalloading();"><?php echo stripslashes($res_post['title']); ?></a>
										</td>
