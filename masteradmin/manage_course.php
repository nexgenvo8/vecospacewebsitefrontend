						...
						<div class="srchfcontct">
							...
							<div class="srch-field">
								<input type="text" name="searchkeywords" id="searchkeywords" maxlength="60"
									placeholder="Enter Course" autocomplete="off"
						...
						<div class="listingbox" style="position:relative;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="12%" align="center" valign="top" class="listingheaddr">Last Modified
									</td>
								</tr>
								<?php while ($res_post = mysql_fetch_array($result)) { ?>
									<tr <?php if ($classlist == 1) { ?>style="background-color:#f7f7f7;" <?php } else { ?>style="background-color:#FFFFFF;" <?php } ?>>
										...
										<td align="left" valign="middle" class="graylist"><a
												...
												onclick="globalloading();"><?php echo stripslashes($res_post['course_name']); ?></a>
										</td>
										<td align="left" valign="middle" class="graylist">
											...
											if ($res_post['dep_name'] != "") {
												...
												foreach ($myArraynew as $my_Array) {
													...
													?>
													<span
														style="width: 100%; display: inline-block; margin-bottom: 2px;"><?php echo $resultkkk['department_name']; ?></span>
												<?php
												}
											}
											?>
