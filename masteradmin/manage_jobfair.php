		...
		<tr>
			...
			<td width="91%" align="left" valign="top">
				...
				<div class="innerouter">
					...
					<?php if ($_REQUEST['action'] == "add") { ?>
						<div class="successmsg" id="wrongloginclick" style="display:block;">Data Imported Successfully
						</div><?php } ?>
						...
						<div class="srchfcontct">
							...
							<div class="srch-field" style="display:none;">
								<select name="userType" id="userType">
									<option value="" <?php if ($_GET['userType'] == "") { ?> selected="selected" <?php } ?>>
										All Users</option>
									<option value="1" <?php if ($_GET['userType'] == 1) { ?> selected="selected" <?php } ?>>
										Student</option>
									<option value="2" <?php if ($_GET['userType'] == 2) { ?> selected="selected" <?php } ?>>
										Faculty</option>
									<option value="3" <?php if ($_GET['userType'] == 3) { ?> selected="selected" <?php } ?>>
										Alumni</option>
									<option value="4" <?php if ($_GET['userType'] == 4) { ?> selected="selected" <?php } ?>>
										Industry Professional</option>
									<option value="5" <?php if ($_GET['userType'] == 5) { ?> selected="selected" <?php } ?>>
										Career Enhancer / Service Provider</option>
									<option value="0" <?php if ($_GET['userType'] == 0 && $_GET['userType'] != "") { ?>
											selected="selected" <?php } ?>>Not Yet Selected</option>
								</select>
							</div>
							<div class="srch-field">
								<div>&nbsp;</div>
						...
						<div class="listingbox" style="position:relative; min-height:300px;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="7%" align="center" valign="top" class="listingheaddr">Student Id Proof
									</td>
									<td width="7%" align="center" valign="top" class="listingheaddr">Student Id Type
									</td>
			...
			<input type="checkbox" name="check_list[]" class="chk" id="check_list[]"  value="<?php echo $res_post['userId']; ?>" />       </td>-->
										...
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['registrationNo']); ?></td>
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['firstName']); ?>
											<?php echo stripslashes($res_post['lastName']); ?></td>
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['departmentname']); ?></td>
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['coursename']); ?></td>
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['semester']); ?></td>
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['passingyear']); ?></td>
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['email']); ?></td>
										<td align="center" valign="middle" class="graylist">
											<?php echo $res_post['mobile']; ?></td>
										<td align="center" valign="middle" class="graylist">
											<?php echo $res_post['gender']; ?></td>
										<td align="center" valign="middle" class="graylist"><a
												href="<?php echo $websiteurl; ?>uploads/<?php echo $res_post['universityIdAttchment']; ?>"
												target="BLANK__">View</a></td>
										<td align="center" valign="middle" class="graylist">
											<?php echo $res_post['studentId']; ?></td>
										<td align="center" valign="middle" class="graylist"><a
												href="<?php echo $websiteurl; ?>uploads/<?php echo $res_post['studentphotoId']; ?>"
												target="BLANK__">View</a></td>
										<td align="center" valign="middle" class="graylist">
