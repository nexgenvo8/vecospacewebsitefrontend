...
<head>
    ...
    <title><?php if ($_REQUEST['id'] != "") {
        echo "Edit";
    } else {
        echo "Add";
    } ?> -
        <?php echo $_REQUEST['pagetitle']; ?> - <?php echo $profile['company']; ?>
    </title>
