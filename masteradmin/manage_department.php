	 ...
	 <div class="loading" id="globalpageloding" style="display:none;">Please Wait Working...</div>
	  ...
	  <form action="manage_department.php" method="get">
		...
		<div class="srch-field"> 
			<input type="text" name="searchkeywords" id="searchkeywords" maxlength="60" placeholder="Enter Department" autocomplete="off" value="<?php echo $_REQUEST['searchkeywords']; ?>">
		</div>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="3%" align="left" valign="top" class="listingheaddr">S.N.</td>			
           ...
           <td width="14%" align="center" valign="top" class="listingheaddr">Last Modified </td>
           </tr>
		...
		<tr <?php if($classlist==1){ ?>style="background-color:#f7f7f7;" <?php }  else { ?>style="background-color:#FFFFFF;" <?php } ?>>
          ...
          <td align="left" valign="middle" class="graylist"><a href="<?php echo $addeditpage; ?>?id=<?php echo $res_post['id']; ?>&backpage=<?php echo $backpage; ?>&pagetitle=<?php echo $pagetitle; ?>"  onclick="globalloading();"><?php  echo stripslashes($res_post['department_name']); ?></a></td>
