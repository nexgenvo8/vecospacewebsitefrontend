								...
								<tr>
									<td width="62%" align="left" valign="middle"><a
											...
											onclick="globalloading();"><input type="button" name="Submit"
												...
												style="position: relative; padding: 3px 15px; border: 0; height: auto; background-color: #860E66; color: #fff; border-radius: 0px 3px 3px 0; box-sizing: border-box; cursor: pointer;" /></a>
									</td>
