...
$backpage = "manage_department.php";
$targetpage = "manage_department.php";
$tableName = "departmentMaster";
$addeditpage = "add_department.php";
$limit = 100;
		...
		<tr>
			...
			<td width="91%" align="left" valign="top">
				...
				<div class="innerouter">
							...
							<tr>
								...
								<td width="150" align="right" style="width:150px;"><em><strong>
											...
											if ($_GET['searchkeywords'] != '') {
												$searchname = "and department_name='" . $_GET['searchkeywords'] . "'";
											}

											$classlist = 1;
											$query = "SELECT COUNT(*) as num FROM departmentMaster where  1 " . $searchname . " order by id desc ";
											...
											$query1 = "SELECT * FROM departmentMaster where  1 " . $searchname . " order by id desc LIMIT $start, $limit";
					...
					<form action="manage_department.php" method="get">
					...
					<form action="" method="post">
						<div class="optionsec">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="62%" align="left" valign="middle"><a
											href="<?php echo $addeditpage; ?>?backpage=<?php echo $backpage; ?>&pagetitle=<?php echo $pagetitle; ?>"
											onclick="globalloading();"><input type="button" name="Submit"
												value="Add New" class="greenbtn"
												style="position: relative; padding: 3px 15px; border: 0; height: auto; background-color: #0074CB; color: #fff; border-radius: 0px 3px 3px 0; box-sizing: border-box; cursor: pointer;" /></a>
									</td>
						...
						<div class="listingbox" style="position:relative;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="53%" align="left" valign="top" class="listingheaddr">Name</td>
									<td width="20%" align="left" valign="top" class="listingheaddr">Status</td>
									<td width="17%" align="center" valign="top" class="listingheaddr"> Date Added </td>
									<td width="14%" align="center" valign="top" class="listingheaddr">Last Modified
									</td>
								</tr>
								<?php while ($res_post = mysql_fetch_array($result)) { ?>
									<tr <?php if ($classlist == 1) { ?>style="background-color:#f7f7f7;" <?php } else { ?>style="background-color:#FFFFFF;" <?php } ?>>
										...
										<td align="left" valign="middle" class="graylist"><a
												href="<?php echo $addeditpage; ?>?id=<?php echo $res_post['id']; ?>&backpage=<?php echo $backpage; ?>&pagetitle=<?php echo $pagetitle; ?>"
												onclick="globalloading();"><?php echo stripslashes($res_post['department_name']); ?></a>
										</td>
										<td align="left" valign="left" class="graylist">
											<?php echo ($res_post['status'] == 1) ? "Active" : "Inactive" ?></td>
										<td align="center" valign="middle" class="graylist">
											<?php echo date('d/m/Y H:i:s', $res_post['dateAdded']); ?></td>
										<td align="center" valign="middle" class="graylist">
											<?php echo date('d/m/Y H:i:s', $res_post['modifyDate']); ?></td>
									</tr>
