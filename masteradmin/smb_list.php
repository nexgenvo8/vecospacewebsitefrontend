...
if ($_GET['status'] != "" && $_GET['unino'] == $_SESSION["cust_session_token"] . "_console") {
    ...
    <img src="' . $websiteurl . 'images/sdglogo.png" width="150px;">
    </a>
</div>
		...
		<tr>
						...
						<div class="listingbox" style="position:relative; min-height:300px;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="28%" align="left" valign="top" class="listingheaddr">Short Description
									</td>
			...
			<input type="checkbox" name="check_list[]" class="chk" id="check_list[]"  value="<?php echo $res_post['userId']; ?>" />       </td>-->
										...
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['companyBusinessName']); ?></td>
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['shortDescription']); ?></td>
										<td align="left" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['cityName']); ?>,
											<?php echo stripslashes($res_post['stateId']); ?>,
											<?php echo stripslashes($res_post['countryId']);
											if ($res_post['postalCode'] != '') { ?>
												- <?php echo $res_post['postalCode'];
											} ?></td>
										<td align="center" valign="middle" class="graylist">
											<?php echo stripslashes($res_post['completeAddress']); ?></td>
										<!--<td align="left" valign="middle" class="graylist"><?php echo stripslashes($user_res['email']); ?></td>-->
										<td align="center" valign="middle" class="graylist">
											<?php echo date("d-m-Y H:i:s", strtotime($res_post['dateAdded'])); ?></td>
										<td align="center" valign="middle" class="graylist">
