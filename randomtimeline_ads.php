...
if ($resLogin) {
	while ($row = mysqli_fetch_array($resLogin)) {
		...
		?>
		<div class="timlist" id="<?php $views = $rowResults['views'] + 1;
		$postid = $rowResults['id'];
		echo $rowResults['id']; ?>" style="margin-bottom:8px;">
			<div class="txtarea">
			...
			<div class="timlist-fttr">
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td width="15%">
							<div id="post<?php echo $row["postId"]; ?><?php echo $row["postType"]; ?>" onclick="postlike(<?php echo $row["postId"]; ?>,<?php echo $row["postType"]; ?>,<?php if ($totalpostlike != '') {
											echo $totalpostlike;
										} else {
											echo '0';
										} ?>);">
						...
						<td width="20%" align="right">
							<div><a
									onClick="sharefuncommonpopupwin('550px','auto','<?php echo $fullurl; ?>common_popup_inner.php?id=<?php echo encodeStr($row['postId']); ?>&type=share&sharePostType=<?php echo $row['postType']; ?>','Share','<?php echo $rowResults['id']; ?>');"><i
				...
				<div class="commnts-cont">
					<div class="comnt-write">
						...
						<div class="cmnt-inpt">
							<form class="edit-layer" enctype="multipart/form-data" name="frmposthome" id="frmposthome"
								...
								<input name="userId" id="userId" type="hidden"
									value="<?php echo encodeStr($userres['userId']); ?>">
