...
<br>
		  ...
		  <a href="<?php echo $fullurl;?>"><button style="background-color:#e0e0e0; float:none; color:#333; margin-right:10px;" type="button" class="continue-process-btn">Back to login page</button></a>
	  </div>
