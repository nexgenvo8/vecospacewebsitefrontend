<?php
$jcarousellite = isset($_GET['jcarousellite']) ? $_GET['jcarousellite'] : 0;
if ($jcarousellite != 1) { ?>
			...
			<div class="right-box-cont" id="similarProfilesDiv">
				<div class="suggest-box">
					...
					<ul class="trending-list">
						...
						AND userId!='" . intval($userwhereid) . "' 
						AND (type IS NULL OR LOWER(type) != 'admin') 
						" . $strWhereContacts . " 
		...
		<?php if ($_SESSION["sessUserId"] != '' && $_SESSION["sessUserId"] != 0) { ?>
			<div class="right-fttr">
				...
				<div class="pwrddebox">
					...
					<div style="float:left"> <a href="https://corrintech.com/"><img
