...
<div style="text-align:left; margin-top:20px; margin-bottom:40px;"><a href="' . $fullurl . 'timeline.html" style="text-decoration:none;"><input name="" type="button" style="background-color:#860E66; padding:12px 30px; outline:0px; border:0px; border-radius: 3px; color:#FFFFFF; font-size:16px;" value="Explore ' . $companNameTitle . '"></a></div>
