						...
						<div id="stepsdetail">
							...
							<div class="half-input">
								...
								<style>
									...
									.udropdown .divunewmain option {
										padding: 8px 10px;
										font-size: 13px;
									}

									.udropdown .divunewmain option:hover {
							...
							<button type="button" class="continue-process-btn"
								onClick="savedatafun(1);">Continue</button>
						</div>
						...
						<div id="stepsdetail1" style="display:none;">
							...
							<div class="half-input" id="jobtitlediv" style=" display:none;">
								...
								<input type="text" name="jobTitle" id="jobTitle" placeholder="Enter Job Title"
									onKeyUp="hideerrordiv(this.id);" maxlength="100">
							</div>
							...
							<button type="button"
								onClick="formValidation('personaldatafrm');$('#txtHiddenFld').val('1');savelastdatafun(1);"
								class="continue-process-btn">Continue</button>
						</div>
