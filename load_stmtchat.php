				...
				<div class="userchatboxmain">
					<div class="userchatboxmain_user">
						...
						<div class="userchatboxmain_name"
							style="font-size: 16px; font-weight: 600;color: #860E66;    text-align: left;margin-left: 70px ">
				...
				<div class="userchatboxmain">
					<div class="userchatboxmain_me">
						...
						<div class="userchatboxmain_name_me"
							style="font-size: 16px; font-weight: 600;color: #860E66;     text-align: right;    margin-right: 70px;">
