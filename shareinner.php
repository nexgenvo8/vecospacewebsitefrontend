...
<li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url; ?>" target="_blank" class="fb"><i
      class="fa fa-facebook" aria-hidden="true"></i><span>Facebook</span></a></li>
<li><a href="https://twitter.com/intent/tweet?text=<?php echo $title; ?> via%20@Konestt&url=<?php echo $url; ?>"
    class="tw"><i class="fa fa-twitter" aria-hidden="true"></i><span>Twitter</span></a></li>
<li><a href="https://www.linkedin.com/sharing/share-offsite?mini=true&url=<?php echo $url; ?>" class="ln"><i
      class="fa fa-linkedin" aria-hidden="true"></i><span>Linkedin</span></a></li>
<li><a href="#" class="kn" onclick="$('.konect-share-pop').show();"><i class="fa"><img
        src="images/k-alumni-logo.png"></i><span><?php echo $companNameTitle; ?></span></a>
