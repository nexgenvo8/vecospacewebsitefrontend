...
<body style="background-image:none;">
        ...
        <div class="container">
            <div class="logo">
                <a style="margin-top:0px; margin-bottom:0px;" href="<?php echo $fullurl; ?>"><img
                        src="images/sgtlogo.png" style="width: 275px;" /></a>
            </div>
    ...
    <div class="container">
        <div class="helpwrap-cont">
            <?php include('sgt_left_link.php'); ?>
            <div class="right-panel">
                <p><strong>Privacy Policy Notice</strong></p>

                <p>Our Privacy Policy explains how SGT VECOSPACE collects, uses, and discloses
                    information about you.
                    The terms &ldquo;SGT VECOSPACE,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; and
                    &ldquo;our&rdquo;
                    include SGT VECOSPACE, Inc. and our affiliates. We use the terms
                    &ldquo;member,&rdquo;
                ...
                <p style="margin-left:53.45pt">SGT VECOSPACE stores this contact information only to
                    send these
                ...
                <ol>
                    ...
                    <li>Detect, investigate, and prevent fraudulent transactions, abuse, and other illegal activities;
                        to protect the rights, property, or safety of SGT VECOSPACE and others; to
                        enforce compliance
                ...
                <p>If you are a member of a group, this group may now or in the future become part of a network of
                    groups known as a &ldquo;SGT VECOSPACE Pro&rdquo; network. Members who administer a
                    SGT VECOSPACE
                ...
                <p>3.5<strong>Following the Law and Protecting SGT VECOSPACE</strong></p>
                ...
                <p>We may access, preserve, and disclose information about you to third parties, including the content
                    ...
                    or prevent fraud or abuse of, SGT VECOSPACE or others.</p>
                ...
                <p>If SGT VECOSPACE is involved in a merger, acquisition, financing, reorganization,
                    bankruptcy, or sale
                ...
                <p>You may update or correct your account information by editing your account settings or by sending a
                    request to privacy@SGT VECOSPACE.com as described inYou may deactivate your account
                    by editing your
                ...
                <p>You can control messages that you receive from SGT VECOSPACE, other members, and
                    third parties by
                ...
                <p>We respond to all requests that we receive from individuals who wish to exercise their data
                    ...
                    an email to privacy@SGT VECOSPACE.com.</p>
                ...
                <p>Under Indian Subcontinent data protection law, the controller of your information is SGT VECOSPACE,
                    Inc.If you have any questions or complaints about this Privacy Policy or how we use your
                    information, please contact privacy@SGT VECOSPACE.com.</p>
