    ...
    <div style="padding:30px;">
      ...
      <div style="padding:10px; background-color:#F9F9F9; border:dashed 1px #ccc; border-radius: 2px;">
        ...
        <div style="color: #696969; margin-bottom: 22px; font-size: 15px; line-height: 20px;text-align: center; border-bottom: solid 1px #e7e7e7; padding-bottom: 10px; border-top: solid 1px #e7e7e7; padding-top: 10px;"><p>If you really have, please click on the below link to create a new one</p>
          ...
          <a href="' . $fullurl . 'reset-password.html?_j=' . $strEmail . '" target="_blank"  style="float: none; display: inline-block; padding: 8px 13px; background-color: #C02621; text-decoration: none; color: #fff; margin-left: 0; margin-top: 10px;">Create a new password</a>
        </div>
...
<body style="background-color: #fff;background-image: inherit;overflow: hidden;">
	...
	<style type="text/css">
		...
		.overlay {
			...
			top: 0;
			background: #C02621;
			background: -moz-linear-gradient(top, #D44D45 0%, #8F1C19 100%);
			background: -webkit-linear-gradient(top, #D44D45 0%, #8F1C19 100%);
			background: linear-gradient(to bottom, #D44D45 0%, #8F1C19 100%);
			filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#D44D45', endColorstr='#8F1C19', GradientType=0);
