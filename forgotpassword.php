...
if (isPost()) {
	...
	<a href="' . $fullurl . 'timeline.html"><img src="' . $fullurl . 'images/sgtlogo.jpg" width="150"></a>
</div>
    ...
    <div style="padding:30px;">
      ...
      <div style="padding:10px; background-color:#F9F9F9; border:dashed 1px #ccc; border-radius: 2px;">
        ...
        <div style="color: #696969; margin-bottom: 22px; font-size: 15px; line-height: 20px;text-align: center; border-bottom: solid 1px #e7e7e7; padding-bottom: 10px; border-top: solid 1px #e7e7e7; padding-top: 10px;"><p>If you really have, please click on the below link to create a new one</p>
          ...
          <a href="' . $fullurl . 'reset-password.html?_j=' . $strEmail . '" target="_blank"  style="float: none; display: inline-block; padding: 8px 13px; background-color: #0074CB; text-decoration: none; color: #fff; margin-left: 0; margin-top: 10px;">Create a new password</a>
        </div>
...
<body style="background-color: #fff;background-image: inherit;overflow: hidden;">
		...
		<div class="banner">
			<div class="container">
				<div class="second-step" <?php if (isset($_GET['send']) && $_GET['send'] == 1) { ?>style="width:500px;"
					<?php } ?>>
					<h2 style="text-align:center; color:#0074CB;">Forgot Password</h2>
	...
	<style type="text/css">
		...
		.overlay {
			...
			top: 0;
			background: #0074CB;
			background: -moz-linear-gradient(top, #0074CB 0%, #005fa3 100%);
			background: -webkit-linear-gradient(top, #0074CB 0%, #005fa3 100%);
			background: linear-gradient(to bottom, #0074CB 0%, #005fa3 100%);

			filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#0074CB', endColorstr='#6dc8e7', GradientType=0);
		}
	</style>
</body>
