...
if (isPost()) {
    ...
    if (trim($action) == 'add') {
        ...
        if (trim($errMsg) == '') {
            ...
            $mailBodyContent = '';
            $newfullurl = 'https://jmialumni.vecospace.com/';
            $mailBodyContent = '<div style="padding:20px 0px; text-align:center; background-color:#FFFFFF;"><a href="' . $newfullurl . 'timeline.html" style="border:0px;">
		<img src="' . $newfullurl . 'images/alumni-ndimlogo.png" width="217" style="border:0px;"></a></div><div style="background-color:#f4f4f4; font-family:Arial, Helvetica, sans-serif; font-size:13px; overflow:scroll; padding:30px 0px;text-align:center;">
...
<div style="text-align:left; margin-top:20px; margin-bottom:30px;">
  <a href="' . $newfullurl . 'confirm-registration.html?_j=' . $strEmail . '" style="text-decoration:none;">
...
<body style="background-color: #fff;background-image: inherit;">
    <div id="wrapper">
        <header class="container">
            <div class="alumni-ndimlogo.png alumni-ndimlogo.png_marg"><a href="<?php echo $fullurl; ?>"><img
                        src="<?php echo $fullurl; ?>images/alumni-ndimlogo.png"></a></div>
        ...
        <div class="banner" style="background-image: url(../images/alumni-backgroundlogin.png); !important">
