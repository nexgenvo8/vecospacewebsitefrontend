...
<li>
       <div class="rquest-box">
        <a href="<?php echo $fullurl; ?>profile/<?php echo encodeStr($userres2["userId"]); ?>/<?php echo $friendnameurl2; ?>.html" target="_blank" class="rqst-img"><img src="<?php echo $fullurl; ?>uploads/<?php echo $userphoto2;?>"></a>
		
        <div class="rqst-right">
<div class="rquest-middle">
<a href="<?php echo $fullurl; ?>profile/<?php echo encodeStr($userres2["userId"]); ?>/<?php echo $friendnameurl2; ?>.html" target="_blank"><?php echo $userres2["firstName"];?> <?php echo $userres2["lastName"];?></a>
<div style="font-size:12px; color:#9a9a9a;"><?php echo $userres2["jobTitle"];?> at <?php echo $userres2["companyName"];?></div>
