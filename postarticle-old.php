...
<head>
	...
	<script language="JavaScript" type="text/javascript"
		src="<?php echo $fullurl; ?>ckeditor/ckfinder/ckfinder.js"></script>
...
<body style="background:none;">
	<div class="article">
		<div class="artcl-head">
			<div class="logo"><a href="<?php echo $fullurl; ?>timeline.html"><img
						src="<?php echo $fullurl; ?>images/alumni-alumni-logo.png"></a></div>
		...
		<form name="frmposthomeimg" id="frmposthomeimg" method="post" enctype="multipart/form-data"
			style=" position:relative;" target="actionfrm" action="<?php echo $fullurl; ?>common_action.php">
	...
	margin: auto; cursor:pointer;">
		...
		<form name="frmposthome" id="frmposthome" class="txt-form" method="post" enctype="multipart/form-data">
			...
			<input name="imagefilehome" id="imagefilehome" type="file" onChange="$('#frmposthome').submit();"
