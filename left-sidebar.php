		...
		<div class="menu">
			...
			<li style="">
				<a href="<?php echo $fullurl; ?>find-mentor.html"
					...
					<i class="micon" style="background-color: #C02621;"><i class="fa fa-handshake-o"
			...
			<li style="">
				<a href="<?php echo $fullurl; ?>articles-and-trivia.html"
					...
					<i class="micon" style="background-color: #C02621;"><i class="fa fa-file-text-o"
							aria-hidden="true"></i></i>
			...
			<li style="">
				<a href="<?php echo $fullurl; ?>smb.html"
					...
					<i class="micon" style="background-color: #C02621;"><i class="fa fa-industry"
							aria-hidden="true"></i></i>
					...
					<li style="">
						<a href="<?php echo $fullurl; ?>all-notice.html"
							...
							<i class="micon" style="background-color: #C02621;"><i class="fa fa-file-text"
									aria-hidden="true"></i></i>
							<!--<img src="images/bl_739_talent_lamp_businessman_lamp_energy_creativity_idea-512.png">-->
					...
					<li class="hiden-d">
						<a href="<?php echo $fullurl; ?>settings.html" class="ripple">
							<i class="micon" style="background-color: #C02621;"><i class="fa fa-cog" aria-hidden="true"></i></i>
				...
				<div>
					<ul class="studenmentlist111" style="text-align:right;">
						...
						if (isset($_SESSION['sessUserId']) && !empty($_SESSION['sessUserId'])) {
							...
							$sqlLogin = "
							SELECT studentId
							FROM " . _STUDENT_REQUEST_MENTOR_FRND_MASTER_TABLE_ . "
							WHERE mentorId = $sessUserId
							AND status = 1
							GROUP BY studentId
							";
							...
							while ($rowLogin = mysqli_fetch_assoc($resLogin)) {
								...
								FROM " . _STUDENT_MENTOR_CHAT_MASTER_TABLE_ . " c
								JOIN " . _USERS_MASTER_TABLE_ . " u ON u.userId = c.contactId
								WHERE c.userId = $sessUserId
								AND c.contactId = $studentId
								AND u.type != 'admin'
								AND c.status = '0'
								";
...
.usrnme {
    ...
    max-width: 150px;     /* apni design ke hisab se badha sakte ho */
    white-space: nowrap;
    overflow: hidden;
