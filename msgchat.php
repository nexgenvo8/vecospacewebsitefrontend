...
<div class="chats" id="loadchatusermsg" style="height:410px; padding-bottom:10px; border-bottom:2px solid #860E66;">
</div>
			...
			<li style="float:right;">
				<div class="send-sec">
					...
					<button class="send" id="sendbuttonchat" onclick="clicktosendchat();"
						style="display:none; background-color:#860E66;">
						Send
					</button>

					<div class="click-btn">
						<a id="sendclick">
							<i style="color:#860E66;" class="fa fa-ellipsis-h" aria-hidden="true"
