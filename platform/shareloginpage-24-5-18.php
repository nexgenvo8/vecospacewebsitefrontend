...
<div class="shareupdate-inner">
             <div style="padding:10px; border-bottom:2px #CCCCCC solid; text-align:center;"><img src="<?php echo $fullurl;?>images/logo.jpg" width="193"></div>
   ...
   <div class="prfl_img"><img src="<?php echo $fullurl;?>uploads/<?php echo $userprofilePhoto; ?>"> </div>
   <div class="hdr_right"><?php echo $userfullname;?>
           
           <label class="time"><?php echo $userjobTitle;?> - <?php echo $usercompanyName;?>      </label>
...
<span id="hpotohomeid">
 <input name="imagefilehome" id="imagefilehome" type="file" onChange="homeuploadfun();" style=" position:absolute; left:0px; top:0px; width:100%; height:100%;cursor: pointer; opacity: 0; filter: alpha(opacity=0); " accept="image/x-png,image/gif,image/jpeg"></span>
  ...
  <button type="submit" onClick="$('#postpost').val(1);">Post</button>
		...
		<div style="border-bottom: dotted 1px #e7e7e7; padding-bottom: 5px; max-width: 512px; margin: auto; margin-bottom: 10px;">
		<a onClick="closewindow();"><?php if(trim($_REQUEST["myId"])!='' && trim($_REQUEST["myId"])!=0){}else{?><strong style="color: red;">Close this window</strong><?php }?></a>
		</div>
