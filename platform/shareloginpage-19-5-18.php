...
<body style="background-color: #fff;background-image: inherit;">
  <div id="wrapper">
    ...
    <div class="shareupdate-inner">
      <div style="padding:10px; border-bottom:2px #CCCCCC solid; text-align:center;"><a
          href="<?php echo $fullurl; ?>timeline.html" class=""><img
            src="<?php echo $fullurl; ?>images/alumni-alumni-logo.png" width="193"></a></div>
          ...
          <div class="tab_contnt_cont" style="border-radius:0 0 2px 2px">
            <div class="tab_contnt" style="position:relative;">
              ...
              <textarea name="postText" id="postText" placeholder="Share an update, article or news"
                ...
                onClick="$('#myheaderid').show();"><?php echo $url; ?></textarea><input type="hidden" name="tageduserid"
                id="tageduserid" value="">
    ...
    margin: auto; margin-bottom: 10px;"><strong style="color: red;">Close this window</strong></a> &copy; 2018 The
        copyright is OMSR Media Pvt. Ltd.
      </div>
