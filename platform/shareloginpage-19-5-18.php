...
<div class="shareupdate-inner">
             <div style="padding:10px; border-bottom:2px #CCCCCC solid; text-align:center;"><a href="<?php echo $fullurl;?>timeline.html" class=""><img src="<?php echo $fullurl;?>images/logo.jpg" width="193"></a></div>
			
			 <form class="edit-layer sharemobile" enctype="multipart/form-data" name="frmposthome" id="frmposthome" method="post" target="actionfrm" action="<?php echo $fullurl;?>common_action.php" style="width:512px; margin:auto;"> 
   ...
   <div class="prfl_img"> <a href="<?php echo $fullurl;?>myprofile/<?php echo encodeStr($_SESSION['sessUserId']);?>/<?php echo $userurl;?>.html"><img src="<?php echo $fullurl;?>uploads/<?php echo $myprofilePhoto; ?>"></a> </div>
   <div class="hdr_right"><a href="<?php echo $fullurl;?>myprofile/<?php echo encodeStr($_SESSION['sessUserId']);?>/<?php echo $userurl;?>.html"><?php echo $myname;?></a>
           ...
           <label class="time"><?php echo $jobTitle;?> - <?php echo $companyName;?>      </label>
			 ...
			 <div id="tagcontactdiv" style="display:none;"></div>
			  <textarea name="postText" id="postText" placeholder="Share an update, article or news" onKeyUp="getsitecontent(); showmyheader();" onBlur="showmyheader();" onClick="$('#myheaderid').show();"><?php echo $url; ?></textarea><input type="hidden" name="tageduserid" id="tageduserid" value="">
...
<span id="hpotohomeid">
 <input name="imagefilehome" id="imagefilehome" type="file" onChange="homeuploadfun();" style=" position:absolute; left:0px; top:0px; width:100%; height:100%;cursor: pointer; opacity: 0; filter: alpha(opacity=0); " accept="image/x-png,image/gif,image/jpeg"></span>
  ...
  <button type="submit" onClick="$('#postpost').val(1);">Post</button>
		...
		<div style="padding:10px; background-color:#e6f8dd; color:#333333; display:none;" id="msg">Great! You have successfully shared this update.</div>
		<div style="text-align:center; font-size:12px; margin-top:20px;  padding:0 10px; line-height:20px; padding-bottom:10px; clear: both;">
      <a onClick="closewindow();" style="display: block;border-bottom: dotted 1px #e7e7e7; padding-bottom: 5px; max-width: 512px;
    margin: auto; margin-bottom: 10px;"><strong style="color: red;">Close this window</strong></a> &copy; 2018 The copyright is OMSR Media Pvt. Ltd.
		  </div>
