...
if (isPost()) {
    ...
    if (trim($action) == 'add') {
		...
		<img src="' . $fullurl . 'images/sdglogo.png" width="217" style="border:0px;"></a></div><div style="background-color:#f4f4f4; font-family:Arial, Helvetica, sans-serif; font-size:13px; overflow:scroll; padding:30px 0px;text-align:center;">
...
<div style="text-align:left; margin-top:20px; margin-bottom:30px;">
  <a href="' . $fullurl . 'confirm-registration.html?_j=' . $strEmail . '" style="text-decoration:none;">
    <input name="" type="button" style="background-color:#860E66; cursor:pointer; padding:12px 30px; outline:0px; border:0px; border-radius:3px; color:#FFFFFF; font-size:16px;" value="Confirm e-mail address">
  </a>
</div>
    ...
    <div id="wrapper">
        ...
        <div class="banner">
            ...
            <div class="container mt-5" style="background:white;width: 77%;padding: 15px;">
                <h3 class="" style="color: #860E66">Register Now !!!</h3>
                <form name="registrationtstep1" id="registrationtstep1" method="post">
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4" style="margin-bottom: 10px;">
                                <select class="form-select" name="userstype" id="userstype"
                                    onChange="selectusertypemain(this.value);">
                    ...
                    <button type="submit" class="btn  w-100 mt-4" onClick="formValidation('registrationtstep1');"
                        style="background-color: #860E66;color:#fff">Register Now</button>
                </form>
            </div>
        </div>
        <style>
