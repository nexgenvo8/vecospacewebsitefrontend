      ...
      <div class="hdr_cont container">
        <div class="logo">
          <a href="http://scgindia.in/konectt/php/timeline.html" class="hiden-xs"><img
              src="http://scgindia.in/konectt/php/images/logo.jpg"></a>
        ...
        <div class="sttng-wraper">
          ...
          <ul class="setting_area_list">
            <li>
              <dl>
                <dt>First name</dt>
                <dd>shahrukh <a href="" class="edit_btn">Edit</a></dd>
                <dt>Last name</dt>
                <dd>khan</dd>
                <dt>Birth/Maiden name</dt>
                <dd>---</dd>
              </dl>
            </li>
            <li>
              <dl>
                <dt>Academic title</dt>
            ...
            <li>
              <dl>
                ...
                <dd> xyz <a href="" class="edit_btn">Edit</a> </dd>
              </dl>
            </li>
          </ul>
        </div>
    ...
    <footer>
      <div class="container">
        <div class="footer-menu">
          ...
          <div class="logo"><a href="index.html"><img src="images/ndimlogo.png"></a></div>
        </div>
      </div>
    </footer>
  </div>
